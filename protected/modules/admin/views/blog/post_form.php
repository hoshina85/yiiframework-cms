<div class="content-box"><!-- Start Content Box -->
    ...
    <div class="content-box-content">
        ...
        <?php echo $this->createAbsoluteUrl('/blog/view/', array('lang'=>false)) . '/' . CHtml::activeTextField($model, 'alias', array( 'class' => 'text-input medium-input' )); ?>
        <?php echo CHtml::error($model, 'alias', array( 'class' => 'input-notification errorshow png_bg' )); ?>

        <?php echo CHtml::activeLabel($model, 'catid'); ?>
        <small><?php echo Yii::t('adminblog', 'Choose a category for this post'); ?></small><br />
        <?php echo CHtml::activeDropDownList($model, 'catid', $parents, array( 'prompt' => Yii::t('adminblog', '-- Choose --'), 'class' => 'text-input medium-input' )); ?>
        ...
        <small><?php echo Yii::t('adminblog', 'The language the post can be displayed in.'); ?></small><br />
