<div id="formcenter">
    ...
    <p><?php echo Yii::t('extensions', 'Please fill all required fields and hit the submit button once your done. It may take time for the extension to be displayed publicly.'); ?></p>
    ...
    <div>
        ...
        <small><?php echo Yii::t('extensions', 'Choose a category for this extension'); ?></small><br />
