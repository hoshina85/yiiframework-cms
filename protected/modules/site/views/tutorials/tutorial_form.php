<div id="formcenter">
    ...
    <div>
        ...
        <?php echo CHtml::activeDropDownList($model, 'catid', $categories, array( 'prompt' => Yii::t('tutorials', '-- Choose --'), 'class' => 'textboxcontact' )); ?>
        ...
        <?php echo CHtml::activeDropDownList($model, 'status', array( 0 => Yii::t('admintuts', 'Hidden (Draft)'), 1 => Yii::t('admintuts', 'Open (Published)') ), array( 'class' => 'textboxcontact' )); ?>
