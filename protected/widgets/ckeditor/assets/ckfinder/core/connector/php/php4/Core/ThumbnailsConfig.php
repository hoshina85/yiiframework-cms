...
class CKFinder_Connector_Core_ThumbnailsConfig
{
     ...
     * @access private
     */
    public $_bmpSupported = false;

    public function CKFinder_Connector_Core_ThumbnailsConfig($thumbnailsNode)
    {
